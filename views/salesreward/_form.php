...
if(!$model->isNewRecord){
    $js = '
    $("body").on("beforeSubmit", "form#msalesreward-form", function () {
        var form = $(this);     
...
<div class="msalesreward-form">

    <?php $form = ActiveForm::begin(['id' => 'msalesreward-form']); ?>

    <?= $form->field($model, 'reward_typeid')->textInput(['maxlength' => true,
                'placeholder' => 'Kode Reward Penjualan']) ?>
    ...
    <?= $form->field($model, 'reward_minimum')->textInput([
                'placeholder' => 'Reward Minimum']) ?>

    <?= $form->field($model, 'reward_maximum')->textInput([
                'placeholder' => 'Reward Maximum']) ?>
