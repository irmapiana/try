...
if(!$model->isNewRecord){
    $js = '
    $("body").on("beforeSubmit", "form#mlayout-form", function () {
        var form = $(this);     
...
<div class="mlayout-form">

    <?php $form = ActiveForm::begin(['id' => 'mlayout-form']); ?>

    <?= $form->field($model, 'layoutid')->textInput(['maxlength' => true]) ?>
