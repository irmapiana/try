...
<div class="mpurchasepriceitem-form">

    <?php $form = ActiveForm::begin(['id' => 'mpurchasepriceitem-form']); ?>

    <?= $form->field($model, 'PPitemid')->textInput(['maxlength' => true,
    ...
    <?php
        ...
        echo $form->field($model, 'productid')->widget(Select2::classname(), [
            ...
            'options' => [
                ...
                'onchange'=>'
                    $.post( "'.Yii::$app->urlManager->createUrl('purchaseprice-item/lists?id=').'"+$(this).val(), function( data ) {
    ...
    <?= $form->field($model, 'PPITEM_PRICE')->textInput(['maxlength' => true,
                'placeholder' => 'Harga']) ?>
