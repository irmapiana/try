...
use app\models\MadminandfeeSearch;
 ...
 */
class MadminandfeeController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionIndex()
    {
        $searchModel = new MadminandfeeSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $tampil = false;
    ...
    {
        if (($model = Madminandfee::findOne($id)) !== null) {
            return $model;
        } else {
