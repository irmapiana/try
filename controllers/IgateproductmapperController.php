...
use app\models\IgateproductmapperSearch;
 ...
 */
class IgateproductmapperController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new IgateproductmapperSearch();
    ...
    {
        if (($model = Igateproductmapper::findOne($id)) !== null) {
            return $model;
        } else {
