...
class MmessagetemplateController extends Controller
{
	...
	{
		$searchModel = new Mmessagetemplate();
	...
	public function actionUpdate($id)
	{
		...
		if ($model->load(Yii::$app->request->post()) && $model->save()) {
			...
			if (Yii::$app->conroller->action->id == 'update' && !isnull(Yii::$app->session->get('halamanFilter'))) {
