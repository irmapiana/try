...
use app\models\MgroupmenuitemSearch;
 ...
 */
class GroupmenuitemController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new MgroupmenuitemSearch();
    ...
    {
        if (($model = Mgroupmenuitem::findOne($id)) !== null) {
            return $model;
        } else {
