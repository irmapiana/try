...
use Yii;
use app\models\Rcmapper;
use app\models\RcmapperSearch;
 ...
 */
class RcmapperController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new RcmapperSearch();
    ...
    {
        if (($model = Rcmapper::findOne($id)) !== null) {
            return $model;
        } else {
