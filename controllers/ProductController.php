...
class ProductController extends Controller
{
    ...
    {
        $searchModel = new MproductSearch();
    ...
    public function actionUpdate($id)
    {
        ...
        $schema = \app\models\Mschema::find()->where(['productid'=> $id])->one();
        $used = false;
        if (!is_null($item) || !is_null($schema)) {
            $used = true;
        }
    ...
    {
        if (($model = Mproduct::findOne($id)) !== null) {
            return $model;
        } else {
